...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.display.setStyleSheet(
            '*{background: #979797; color: #121212; font-size:30px;}'
        )
        ...
        self.add_btn(
            ...
            lambda: self.display.setText(''), 'background: #9b0007; color: #fff; font-weight:700;')
        ...
        self.add_btn(
            QPushButton('<-'), 2, 4, 1, 1,
            lambda: self.display.setText(self.display.text()[:-1]),'background: #9a4f00; color: #FFF; font-weight: 700;')
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.eval_igual,'background: #035e00; color: #FFF; font-weight: 700;'
            )
